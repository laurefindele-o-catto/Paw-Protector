      ...
      <div className="min-h-screen bg-[#edfdfd] text-slate-900 overflow-hidden relative flex flex-col mt-28">
        ...
        <header className="w-full mx-auto flex items-center justify-center px-6 md:px-16 py-5 z-20 relative">
          <div className="flex items-center gap-3">
            <div className="h-20 w-30 bg-[#0f172a] rounded-xl flex items-center justify-center text-[#edfdfd] font-bold text-sm animate-[popin_0.5s_ease]">
              Vet Finder
            </div>
        ...
        <main className="px-6 md:px-16 pb-8 grid grid-cols-2 lg:grid-cols-5 gap-6 relative z-10 flex-1">
          {/* Left: Controls + Map */}
          <section className="lg:col-span-2 flex flex-row gap-4">
