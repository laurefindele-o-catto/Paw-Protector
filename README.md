...
### What Are We
![about 1](resources/about_us_1.png) ![about 2](resources/about_us_2.png)  
![about 3](resources/about_us_3.png)

### Disease Detection
Custom trained classification model deployed on Hugging Face.
![disease detection](resources/disease_detection.png)

### Pet Care (RAG Enhanced)
![pet care 1](resources/pet_care.png) ![pet care 2](resources/pet_care_2.png)  
![pet care 3](resources/pet_care_3.png)

### Vet Finder
![vet finder 1](resources/vet_finder.png) ![vet finder 2](resources/vet_finder_2.png)

### Vaccination Alerts
![vaccinations](resources/vaccination.png)

### Chat Interface (RAG)
![chat](resources/chat.png)

### Pet Profile (Data Feeds Retrieval Quality)
![pet profile](resources/pet_profile.png)
